...
const Register = ({navigation}) => { 
    ...
    const handleLogin = () => {
        if (!data.email || !data.password) {
            Toast.show({
                ...
                textBody: 'Por favor complete todos os campo',
              })
          return;
        }
    ...
    return (
      ...
      <View style={styles.header}>
        <Text style={styles.textHeader}>Cria a sua conta Particular</Text>
      </View>
      <Animatable.View 
      style={styles.footer}
      animation="fadeInUpBig">
        ...
        <Ionicons name="eye-off-outline" size={24} color="black" />
         ...
         <View style={styles.button}>
            ...
            <TouchableOpacity style={{alignSelf:'center',marginTop:'25%'}} onPress={() => navigation.navigate('RegisterBusiness')} >
                <Text >Business</Text>
            </TouchableOpacity>
